...
public class RCViewContacto extends AppCompatActivity {
    ...
    public  void  InicializarContactos(){
        ...
        contactos.add(new Contacto("2 38 38 89 747", "perla@gmail.com", R.drawable.sinb));
        contactos.add(new Contacto("55 54 42 78 44", "citla@gmail.com", R.drawable.yeonwoo));
        contactos.add(new Contacto("55 49 33 05 52", "perla.citla@gmail.com", R.drawable.momoland_yeonwoo));
